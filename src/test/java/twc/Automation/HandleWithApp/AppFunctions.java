...
//System.out.println("swipeup");
	...
	public static void Swipe_feed3(){
		Dimension dimensions = Ad.manage().window().getSize();//throwing exception
	...
	//				}
	//			} else {
	//				System.out.println(exceldata[1][Cap] + " module is not present and scrolling scroll");
	//				Swipe();
	//			}
	//		}
	//	}
	...
	public static void selectlocation_nativeBB() throws Exception
    {
        DeviceStatus device_status = new DeviceStatus();
        int Cap = device_status.Device_Status();
try{
...
{
    Ad.findElement(By.id("Search")).click();
}
        Thread.sleep(2000);
        try {
        Ad.findElement(By.id("com.weather.Weather:id/txt_location_name")).sendKeys("38821");      
        }
        catch(Exception e)
        {
            Ad.findElement(By.id("com.weather.Weather:id/search_text")).sendKeys("38821");    
            Thread.sleep(2000);
        }
        Thread.sleep(2000);
	...
	public static void clicktrendingElement() throws Exception
	{
		try {
			Ad.findElementById("com.weather.Weather.qa:id/trending_icon").click();
			Thread.sleep(3000);
		}catch(Exception e) {
			Ad.findElementByAccessibilityId("Trending").click();
			Thread.sleep(3000);
		}
	}
	...
	public static void click_Breathing_element() throws Exception
	{try {
	...
	public static void click_Pollen_element() throws Exception
	{try {
		Ad.findElementByName("POLLEN").click();
		Thread.sleep(3000);
	}
	catch(Exception e) {
	...
	public static void click_MOLD_element() throws Exception
	{try {
		Ad.findElementByName("MOLD").click();
		Thread.sleep(3000);
	}
	catch(Exception e) {
	...
	public static void click_TODAY_element() throws Exception
	{ try {
	...
	public static void click_TOMORROW_element() throws Exception
	{try {
		Ad.findElementByName("TOMORROW").click();
		Thread.sleep(3000);
	}catch(Exception e) {
	...
	public static void click_THIS_WEEK_element() throws Exception
	{try {
		Ad.findElementByName("THIS WEEK").click();
		Thread.sleep(3000);
	}
	catch(Exception e) {
